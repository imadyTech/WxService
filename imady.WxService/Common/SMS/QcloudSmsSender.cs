...
{
    public class QcloudSmsSender : IQcloudSmsSender
    {
        int sdkappid;
        string appkey;
        ...
        public QcloudSmsSender(int sdkappid, string appkey)
        {
    ...
    public class SmsSenderUtil
    {
        ...
        {
            System.Security.Cryptography.SHA256 sha256 = SHA256Managed.Create();
